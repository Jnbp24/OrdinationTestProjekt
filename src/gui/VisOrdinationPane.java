...
public class VisOrdinationPane extends GridPane {
    ...
    public VisOrdinationPane() {
        ...
        lstPatient.getSelectionModel().selectedIndexProperty().addListener(observable -> lstOrdination.getItems().setAll(lstPatient.getSelectionModel().getSelectedItem().getOrdinationer()));
    ...
    public void updateDetails() {
        ...
        if (ordination != null) {
            ...
            if (ordination instanceof DagligFast) {
                ...
                ordinationDetailsPane.setFast(dagligFast.getDoser()[0], dagligFast.getDoser()[1], dagligFast.getDoser()[2], dagligFast.getDoser()[3]);
            }
